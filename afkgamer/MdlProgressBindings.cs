...
namespace l2gamer {
	...
	public delegate void SimpleCallback(GameWindow window);
	...
	public struct tagBITMAPINFOHEADER {
		...
		public UInt32	XScale;
		public UInt32	YScale;
	...
	public class MdlProgressBindings : MdlControlOwner
	{
		...
		public event SimpleCallback ScreenshotUpdate;
		...
		{
			((UcWincExtended)Uc).Init(window, tab);
		}
